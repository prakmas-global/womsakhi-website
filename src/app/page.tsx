...
export default function Home() {
  return <div className="site"><Header/><main><Hero/><Mission/><Offers/><section className="closing ctaClosing"><Image className="ctaLeaves ctaLeavesLeft" src="/assets/mission-leaves.png" alt="" width={230} height={230}/><Image className="ctaLeaves ctaLeavesRight" src="/assets/hero-blush-leaves.png" alt="" width={190} height={190}/><div><span className="ctaLotus" aria-hidden>✦</span><h2>Together We Create Brighter Tomorrows</h2><p>Be a part of a growing community that believes in women, always.</p><a className="light" href={`${APP}/signup`}>Join WomSakhi Today　→</a></div><p className="script">Stronger<br/>Together ♡</p></section></main></div>;
}
